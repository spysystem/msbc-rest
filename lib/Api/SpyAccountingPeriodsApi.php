...
/**
 * SpyAccountingPeriodsApi Class Doc Comment
 *
 * @category Class
 * @package  Spy\MsbcRestClient
 * @author   OpenAPI Generator team
...
class SpyAccountingPeriodsApi
{
    ...
    /**
     * Operation getSpyAccountingPeriods
     *
    ...
    /**
     * Operation getSpyAccountingPeriodsWithHttpInfo
     *
    ...
    public function getSpyAccountingPeriodsWithHttpInfo($filter = null, $select = null, $order_by = null, $top = null, $data_access_intent = 'ReadOnly', string $contentType = self::contentTypes['getSpyAccountingPeriods'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Spy\MsbcRestClient\Model\SpyAccountingPeriodsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Spy\MsbcRestClient\Model\SpyAccountingPeriodsResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Spy\MsbcRestClient\Model\SpyAccountingPeriodsResponse', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Spy\MsbcRestClient\Model\SpyAccountingPeriodsResponse',
    ...
    /**
     * Operation getSpyAccountingPeriodsAsync
     *
     * @param  string $filter (optional)
     * @param  string $select (optional)
     * @param  string $order_by (optional)
    ...
    /**
     * Operation getSpyAccountingPeriodsAsyncWithHttpInfo
     *
     * @param  string $filter (optional)
     * @param  string $select (optional)
     * @param  string $order_by (optional)
    ...
    /**
     * Create request for operation 'getSpyAccountingPeriods'
     *
     * @param  string $filter (optional)
     * @param  string $select (optional)
     * @param  string $order_by (optional)
    ...
    public function getSpyAccountingPeriodsRequest($filter = null, $select = null, $order_by = null, $top = null, $data_access_intent = 'ReadOnly', string $contentType = self::contentTypes['getSpyAccountingPeriods'][0])
    {
        ...
        $resourcePath = '/SpyAccountingPeriods';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
