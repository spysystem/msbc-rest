...
class SpyCalcCustomerBalanceCodeUnitApi
{
     ...
     * @return void
     */
    public function calcCustomerBalance($company, ?int $hostIndex = null, array $variables = [])
    {
        $this->calcCustomerBalanceWithHttpInfo($company, $hostIndex, $variables);
    }
     ...
     */
    public function calcCustomerBalanceWithHttpInfo($company, ?int $hostIndex = null, array $variables = [])
    {
        $request = $this->calcCustomerBalanceRequest($company, $hostIndex, $variables);
     ...
     */
    public function calcCustomerBalanceAsync($company, ?int $hostIndex = null, array $variables = [])
    {
        return $this->calcCustomerBalanceAsyncWithHttpInfo($company, $hostIndex, $variables)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calcCustomerBalanceAsyncWithHttpInfo($company, ?int $hostIndex = null, array $variables = [])
    {
        $returnType = '';
        $request = $this->calcCustomerBalanceRequest($company, $hostIndex, $variables);
    ...
    *    - environment: Environment: something like Production or Sandbox
     ...
     */
    public function calcCustomerBalanceRequest($company, ?int $hostIndex = null, array $variables = [])
    {
