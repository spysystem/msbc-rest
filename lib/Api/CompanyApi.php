...
class CompanyApi
{
     ...
     */
    public function getCompanies(?int $hostIndex = null, array $variables = [])
    {
        list($response) = $this->getCompaniesWithHttpInfo($hostIndex, $variables);
        return $response;
    }
     ...
     */
    public function getCompaniesWithHttpInfo(?int $hostIndex = null, array $variables = [])
    {
        $request = $this->getCompaniesRequest($hostIndex, $variables);
     ...
     */
    public function getCompaniesAsync(?int $hostIndex = null, array $variables = [])
    {
        return $this->getCompaniesAsyncWithHttpInfo($hostIndex, $variables)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCompaniesAsyncWithHttpInfo(?int $hostIndex = null, array $variables = [])
    {
        $returnType = '\Spy\MsbcRestClient\Model\CompaniesListResponse';
        $request = $this->getCompaniesRequest($hostIndex, $variables);
    ...
    *    - environment: Environment: something like Production or Sandbox
     ...
     */
    public function getCompaniesRequest(?int $hostIndex = null, array $variables = [])
    {
