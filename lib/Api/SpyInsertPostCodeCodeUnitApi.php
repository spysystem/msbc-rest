...
class SpyInsertPostCodeCodeUnitApi
{
     ...
     * @param  \Spy\MsbcRestClient\Model\SpyInsertPostCode $spy_insert_post_code spy_insert_post_code (optional)
     ...
     * @return void
     */
    public function insertPostCode($company, $spy_insert_post_code = null, ?int $hostIndex = null, array $variables = [])
    {
        $this->insertPostCodeWithHttpInfo($company, $spy_insert_post_code, $hostIndex, $variables);
    }
     ...
     *
     * @param  string $company Company ID (required)
     * @param  \Spy\MsbcRestClient\Model\SpyInsertPostCode $spy_insert_post_code (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     *
     * @throws \Spy\MsbcRestClient\ApiException on non-2xx response
     ...
     */
    public function insertPostCodeWithHttpInfo($company, $spy_insert_post_code = null, ?int $hostIndex = null, array $variables = [])
    {
        $request = $this->insertPostCodeRequest($company, $spy_insert_post_code, $hostIndex, $variables);
     ...
     */
    public function insertPostCodeAsync($company, $spy_insert_post_code = null, ?int $hostIndex = null, array $variables = [])
    {
        return $this->insertPostCodeAsyncWithHttpInfo($company, $spy_insert_post_code, $hostIndex, $variables)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function insertPostCodeAsyncWithHttpInfo($company, $spy_insert_post_code = null, ?int $hostIndex = null, array $variables = [])
    {
        $returnType = '';
        $request = $this->insertPostCodeRequest($company, $spy_insert_post_code, $hostIndex, $variables);
    ...
    *    - environment: Environment: something like Production or Sandbox
     ...
     */
    public function insertPostCodeRequest($company, $spy_insert_post_code = null, ?int $hostIndex = null, array $variables = [])
    {
        ...
        if (isset($spy_insert_post_code)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($spy_insert_post_code));
            } else {
