...
class JournalLinesPageApi
{
     ...
     * @return void
     */
    public function deleteTempJournalLine($id, ?int $hostIndex = null, array $variables = [])
    {
        $this->deleteTempJournalLineWithHttpInfo($id, $hostIndex, $variables);
    }
     ...
     */
    public function deleteTempJournalLineWithHttpInfo($id, ?int $hostIndex = null, array $variables = [])
    {
        $request = $this->deleteTempJournalLineRequest($id, $hostIndex, $variables);
     ...
     */
    public function deleteTempJournalLineAsync($id, ?int $hostIndex = null, array $variables = [])
    {
        return $this->deleteTempJournalLineAsyncWithHttpInfo($id, $hostIndex, $variables)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTempJournalLineAsyncWithHttpInfo($id, ?int $hostIndex = null, array $variables = [])
    {
        $returnType = '';
        $request = $this->deleteTempJournalLineRequest($id, $hostIndex, $variables);
    ...
    *    - companyID: Company ID
     ...
     */
    public function deleteTempJournalLineRequest($id, ?int $hostIndex = null, array $variables = [])
    {
