...
/**
 * SpyDimensionModelFields Class Doc Comment
 *
 * @category Class
 * @package  Spy\MsbcRestClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SpyDimensionModelFields
{
    public string $strDimensionName = 'dimensionName';
    public string $strDimensionValue = 'dimensionValue';
}
