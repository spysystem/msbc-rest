...
/**
 * SpyCustomerTransResponse Class Doc Comment
 *
 * @category Class
 * @package  Spy\MsbcRestClient
 * @author   OpenAPI Generator team
 ...
 */
class SpyCustomerTransResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return SpyCustomerTransResponseModelFields
      */
    public static function GetModelFields(): SpyCustomerTransResponseModelFields
    {
        return new SpyCustomerTransResponseModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return SpyCustomerTransResponseModelAttributes
      */
    public static function GetModelAttributes(): SpyCustomerTransResponseModelAttributes
    {
        return new SpyCustomerTransResponseModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpyCustomerTransResponse';
    ...
    */
    ...
    {
        $allowedValues = $this->getPaymentPredictionAllowableValues();
        if (!is_null($payment_prediction) && !in_array($payment_prediction, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'payment_prediction', must be one of '%s'",
                    $payment_prediction,
    ...
    {
        $allowedValues = $this->getPredictionConfidenceAllowableValues();
        if (!is_null($prediction_confidence) && !in_array($prediction_confidence, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'prediction_confidence', must be one of '%s'",
