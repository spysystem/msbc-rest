<?php
/**
 * SpyAccountingPeriodModelAttributes
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * SpyAccountingPeriodModelAttributes Class Doc Comment
 *
 * @category Class
 * @package  Spy\MsbcRestClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SpyAccountingPeriodModelAttributes
{
    ...
    public string $strStartDate = 'start_date';
    public string $strPeriodName = 'period_name';
    public string $strClosed = 'closed';
    public string $strNewFiscalYear = 'new_fiscal_year';
}
