<?php
/**
 * SpyAccountingPeriodModelFields
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * SpyAccountingPeriodModelFields Class Doc Comment
 *
 * @category Class
 * @package  Spy\MsbcRestClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SpyAccountingPeriodModelFields
{
    ...
    public string $strStartDate = 'startDate';
    public string $strPeriodName = 'periodName';
    public string $strClosed = 'closed';
    public string $strNewFiscalYear = 'newFiscalYear';
}
