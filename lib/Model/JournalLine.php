...
class JournalLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return JournalLineModelFields
      */
    public static function GetModelFields(): JournalLineModelFields
    {
        return new JournalLineModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return JournalLineModelAttributes
      */
    public static function GetModelAttributes(): JournalLineModelAttributes
    {
        return new JournalLineModelAttributes();
    }
    ...
    */
    ...
    public function setBatchId($batch_id)
    {
        ...
        if ((mb_strlen($batch_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $batch_id when calling JournalLine., must be smaller than or equal to 20.');
        }
