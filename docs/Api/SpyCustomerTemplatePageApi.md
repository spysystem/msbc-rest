...
```php
createCustomerTemplate($spy_customer_template): \Spy\MsbcRestClient\Model\SpyCustomerTemplateResponse
```
...
try {
    $result = $apiInstance->createCustomerTemplate($spy_customer_template);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **spy_customer_template** | [**\Spy\MsbcRestClient\Model\SpyCustomerTemplate**](../Model/SpyCustomerTemplate.md)|  | [optional] |
...
```php
editCustomerTemplate($code, $if_match, $spy_customer_template): \Spy\MsbcRestClient\Model\SpyCustomerTemplateResponse
```
...
try {
    $result = $apiInstance->editCustomerTemplate($code, $if_match, $spy_customer_template);
    print_r($result);
} catch (Exception $e) {
...
```php
getCustomerTemplate($code, $data_access_intent): \Spy\MsbcRestClient\Model\SpyCustomerTemplateResponse
```
...
try {
    $result = $apiInstance->getCustomerTemplate($code, $data_access_intent);
    print_r($result);
} catch (Exception $e) {
