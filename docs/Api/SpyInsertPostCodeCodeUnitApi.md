# Spy\MsbcRestClient\SpyInsertPostCodeCodeUnitApi
...
| ------------- | ------------- | ------------- |
| [**insertPostCode()**](SpyInsertPostCodeCodeUnitApi.md#insertPostCode) | **POST** /SpyInsertPostCode_InsertPostCode |  |


## `insertPostCode()`

```php
insertPostCode($company, $spy_insert_post_code)
```
### URI(s):
...
$apiInstance = new Spy\MsbcRestClient\Api\SpyInsertPostCodeCodeUnitApi(
...
$spy_insert_post_code = new \Spy\MsbcRestClient\Model\SpyInsertPostCode(); // \Spy\MsbcRestClient\Model\SpyInsertPostCode
...
try {
    $apiInstance->insertPostCode($company, $spy_insert_post_code, $hostIndex, $variables);
} catch (Exception $e) {
    echo 'Exception when calling SpyInsertPostCodeCodeUnitApi->insertPostCode: ', $e->getMessage(), PHP_EOL;
}
```
